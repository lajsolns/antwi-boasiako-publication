...
export default function EventsPage() {
  ...
  const events = [
    ...
    },
    {
      ...
      description: "An intimate evening with Dr. Antwi-Boasiako discussing his insights on his latest French publication, 'Les 10 Commandements Pour Un Développement Nationale Durable De La Cybersécurité'. Includes book reading, Q&A session, and personalized book signing.",
        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="font-inter text-lg text-gray-600 max-w-2xl mx-auto">
              Join us for insightful conferences, workshops, and book launches featuring Dr. Antwi-Boasiako and other industry experts.
            </p>
          </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-inter text-sm font-medium"
                  >
