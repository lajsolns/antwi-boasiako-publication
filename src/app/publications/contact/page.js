                    ...
                    <div className="bg-white p-10 md:p-16 border border-gray-100 shadow-xl shadow-gray-100/50 relative">
                        ...
                        <div className="space-y-12">
                            <div className="text-center">
                                <h3 className="font-inter text-sm tracking-widest text-amber-800 uppercase mb-4">{t('contact.location')}</h3>
                                <p className="font-playfair text-2xl text-gray-900">
                                    84 UPSA Road<br />
                                    <span className="text-xl">East Legon, Accra</span>
                                </p>
                                <p className="font-inter text-sm text-gray-500 mt-2 uppercase tracking-wide">GPS: GM-040-9682</p>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-center text-center pt-4 gap-8 md:gap-4">
                                <div>
                                    <h4 className="font-inter text-xs tracking-[0.2em] text-gray-400 uppercase mb-3">{t('contact.phone')}</h4>
                                ...
                                <div>
                                    <h4 className="font-inter text-xs tracking-[0.2em] text-gray-400 uppercase mb-3">{t('contact.email')}</h4>
                                ...
                                <div>
                                    <h4 className="font-inter text-xs tracking-[0.2em] text-gray-400 uppercase mb-3">{t('contact.website')}</h4>
