...
export default function PublicationsPage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: "Les 10 Commandements Pour Un Développement Nationale Durable De La Cybersécurité is the most comprehensive guide I've found for leading organizational change. Dr. Antwi-Boasiako's expertise shines through every chapter.",
      rating: 5,
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="flex flex-col items-center text-center">
              <Link href="/publications/1" className="relative w-full max-w-xs aspect-[3/4] mb-4 overflow-hidden transition-transform duration-300 hover:-translate-y-1 block">
                <Image 
            ...
            <div className="max-w-md flex flex-col">
              ...
              <Link href="/publications/1" className="group">
                <h2 className="font-playfair text-3xl font-bold text-gray-900 leading-tight mb-1 group-hover:text-amber-800 transition-colors duration-300">
                  THE REPUBLIC
                </h2>
              </Link>
...
{/* 
              ...
              <div className="flex gap-3 mb-4">
                ...
                <Link href="/publications/1" className="flex-1 px-4 py-2 text-blue-800 border border-blue-800 font-inter text-sm font-medium hover:bg-blue-800 hover:text-white transition-all duration-200 flex items-center justify-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#" className="font-inter text-gray-300 hover:text-white transition-colors duration-200 text-sm">
                    Les 10 Commandements Pour Un Développement Nationale Durable De La Cybersécurité
                  </a>
                </li>
                <li>
                  <a href="#" className="font-inter text-gray-300 hover:text-white transition-colors duration-200 text-sm">
            ...
            <div>
              ...
              <p className="font-inter text-gray-300 text-sm mb-4">
                Subscribe for updates on new publications, and professional developments.
              </p>
