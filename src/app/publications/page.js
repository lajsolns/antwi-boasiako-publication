...
export default function PublicationsPage() {
  ...
  const featuredBooks = [
    ...
    },
    {
      ...
      internationalPrice: "55.00",
      ghanaPrice: "500",
      description: "Naviguez dans le paysage complexe de l'évolution numérique organisationnelle avec ce guide de leadership stratégique. Le Dr Antwi-Boasiako combine expertise technique et sens des affaires pour fournir des informations exploitables pour une transformation numérique réussie. De la modernisation des systèmes hérités à la gestion du changement culturel, ce livre fournit les outils et les cadres nécessaires pour guider les organisations à travers la révolution numérique.",
      category: 'academic',
      coverImage: '/image/book_mockup_french.png',
      authorBio: "Leader d'opinion reconnu en matière de transformation numérique, le Dr Antwi-Boasiako a aidé de nombreuses organisations à travers l'Afrique à naviguer avec succès dans leur parcours numérique.",
      isbn10: "9988399316",
  ...
  const currentUpcomingEvent = upcomingEvents.length > 0 ? upcomingEvents[currentUpcomingIndex] : null;
    ...
    <div className="min-h-screen bg-white" style={{ borderRadius: '0' }}>
      ...
      >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="flex flex-col items-center justify-center relative">
                <Link href="/publications/1" className="relative w-full max-w-md aspect-[3/4] overflow-hidden group">
              ...
              <div className="max-w-md flex flex-col pl-0 lg:pl-8">
                ...
                <Link href="/publications/1" className="group">
                  <h2 className="font-playfair text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4 group-hover:text-amber-800 transition-colors duration-300">
                    The Republic
                  </h2>
                </Link>
              ...
              >
                ...
                <div className="flex gap-4 mb-4">
                  ...
                  <Link href="/publications/1" className="flex-1 px-4 py-3 text-gray-600 border border-gray-300 font-inter text-xs tracking-wide uppercase hover:border-gray-900 hover:text-gray-900 transition-all duration-300 flex items-center justify-center gap-2">
        ...
        <section className="py-24 px-8 bg-[#FAF9F6] border-t border-gray-100">
          <div className="max-w-6xl mx-auto">
            {(!showPastEvents && upcomingEvents.length > 0) ? (
              <div>
                <div className="text-center mb-16 space-y-4">
                  ...
                  <div className="bg-white border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-500">
                    <div className="grid md:grid-cols-2 gap-0">
                      ...
                      <div className="p-8 md:p-12 flex flex-col justify-between">
                        ...
                        <Link href={`/publications/events/${currentUpcomingEvent.id}`} className="block text-center w-full px-8 py-4 bg-gray-900 text-white border border-gray-900 font-inter text-sm tracking-widest uppercase hover:bg-transparent hover:text-gray-900 transition-all duration-300">
            ...
            {(showPastEvents || upcomingEvents.length === 0) && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                {pastEvents.slice(0, 3).map((event) => (
                  <Link href={`/publications/events/${event.id}`} key={event.id} className="block bg-white shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
            ...
            {(showPastEvents || upcomingEvents.length === 0) && pastEvents.length > 3 && (
        ...
        <section className="py-24 px-8 bg-[#FAF9F6]">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-16 items-center transition-all duration-500">
              {[
                { src: "/image/partners/un-emblem.svg", alt: "United Nations" },
                { src: "/image/partners/e-crime-logo.png", alt: "e-Crime Bureau" },
                { src: "/image/partners/GIIMPA.png", alt: "GIMPA" },
                { src: "/image/partners/VIA-Logo.png", alt: "VIA Consulting" },
                { src: "/image/partners/unieri.png", alt: "UNIERI" },
                { src: "/image/partners/ACCRA-MET-LOGO-3-1.png", alt: "Accra Metropolitan Assembly" }
              ].map((partner, i) => (
                <div key={i} className="flex items-center justify-center">
                  <div className="w-full h-28 flex items-center justify-center relative group/logo">
                    <Image 
                      src={partner.src} 
                      alt={partner.alt} 
                      fill 
