...
export default function PublicationsHeader({
  ...
  return (
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-8 pt-4 pb-4 relative h-28 lg:h-32 flex items-center justify-between">
          ...
          <div className="flex items-center justify-center flex-1">
            <Link href="/publications" className="flex items-center no-underline text-gray-900 group">
              <Image
                ...
                width={500}
                height={500}
                className="w-28 h-28 lg:w-32 lg:h-32 object-cover cursor-pointer"
              />
            </Link>
          </div>
        ...
        {/* Mobile Menu Overlay */}
          <div
            className={cn(
              "fixed inset-0 bg-[#FAF9F6] z-[60] lg:hidden transition-all duration-500 ease-in-out transform",
...
{/* Decorative Background Elements */}
          ...
          {/* Header in Overlay */}
          <div className="flex flex-col items-center justify-center px-8 h-28 border-b border-gray-100 bg-[#FAF9F6] relative">
          ...
          <div className="h-[calc(100vh-112px)] overflow-y-auto px-8 py-6 flex flex-col justify-between">
              ...
              <div className="hidden lg:flex items-center space-x-8">
                {[
                  ...
                  <Link
                    key={href}
                    href={href}
                    className="font-inter text-[13px] tracking-[0.15em] uppercase text-gray-700 hover:text-amber-800 transition-colors duration-200 relative group"
                  >
